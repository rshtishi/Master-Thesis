...
public class RelGTExp extends LogicExp
{
	...
	public RelGTExp(String s1,String t1,String s2,String t2)
	{
		this.s1=s1;
		this.s2=s2;
		this.t1=t1;
	...
	public RelGTExp(String s1,String t1,String s2,String t2,LookupTable symbolTable)
	{
		this.s1=s1;
		this.s2=s2;
		this.t1=t1;
